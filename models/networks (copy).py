...
def load_pretrained_personal_model(model, path):
...
def define_G(input_nc, output_nc, ngf, which_model_netG, segmdataroot, norm='batch', use_dropout=False, gpu_ids=[], use_parallel = True, learn_residual = False):
	netG = None
	...
	if which_model_netG == 'resnet_9blocks':
		...
		netG = ResnetGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=15, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
		...
		netG = Encode_Decode_seg(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
	elif which_model_netG =='encode_decode_vessel_res':
		netG = Encode_Decode_seg_res(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
	elif which_model_netG =='encode_decode':
		netG = Encode_Decode(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
	elif which_model_netG =='encode_decode_res':
		netG = Encode_Decode_res(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
	elif which_model_netG =='encode_decode_vessel_2scale_share':
		netG = Encode_Decode_seg_2scale_share(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
	elif which_model_netG =='encode_decode_vessel_2scale_share_res':
		netG = Encode_Decode_seg_2scale_share_res(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
	elif which_model_netG =='encode_decode_vessel_2scale_share_res_atten':
		netG = Encode_Decode_seg_2scale_share_atten_res(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual = learn_residual)
	else:
	...
	if which_model_netG =='encode_decode_vessel':
		load_pretrained_personal_model(netG,segmdataroot)
...
class Encode_Decode_seg_2scale_share_atten_res_sum(nn.Module):
	...
	def forward(self, input_512, input_256, input_norm):
		...
		# d2 1/4 feature 64 channel
		# d1 1/2 feature 64 channel
		print(output_512.shape)
		print(output_512[0,2,256,256])
		print(input_512[0,2,256,256])
		return output_512, output_256, out,a_mask
