...
import random
class PSF(object):
    def __init__(self, canvas=None, trajectory=None, fraction=None, path_to_save='/home/sz1/medical/code/'):
        if canvas is None:
        ...
        if fraction is None:
            List = [1/100, 1/10, 1/2, 1]
            self.fraction = [random.choice(List)]
    ...
    def fit(self, show=False, save=False):
        ...
        for j in range(self.PSFnumber):
            ...
            for t in range(len(self.trajectory)):
                ...
                # print("m1=%s,m2=%s,M1=%s,M2=%s" % (m1,m2,M1,M2))
