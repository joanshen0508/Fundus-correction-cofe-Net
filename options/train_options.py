...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--lambda_P', type=float, default=0.1, help ='weight for perceptual loss')
		self.parser.add_argument('--lambda_S', type=float, default=0.1, help = 'weight for vessel segmentation module')
